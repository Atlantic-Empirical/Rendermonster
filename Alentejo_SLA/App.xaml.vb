...
Partial Public Class App
    ...
    Private Sub Application_Startup(ByVal o As Object, ByVal e As StartupEventArgs) Handles Me.Startup
        ...
        AddHandler AuthServiceClient.GetClientIPCompleted, AddressOf GetIPAddress_Callback
        AuthServiceClient.GetClientIPAsync()

        Me.RootVisual = New RootPage()
    End Sub
    ...
    Private Sub GetIPAddress_Callback(ByVal sender As Object, ByVal e As GetClientIPCompletedEventArgs)
