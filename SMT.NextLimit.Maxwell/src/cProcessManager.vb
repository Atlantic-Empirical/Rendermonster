...
#Region "Public properties"
        ...
        Public ReadOnly Property PID() As Integer
            Get
                If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "PID() - ENTER")
        ...
        Public ReadOnly Property hasProcessExited() As Boolean
            Get
                If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "hasProcessExited() - ENTER")
...
#Region "Constructors & Destructors"
        ...
        Public Overloads Sub Dispose() Implements IDisposable.Dispose
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "Dispose1() - ENTER")
            Dispose(True)
            ' Take this object off the finalization queue 
            ' and prevent finalization code for this object
            ' from executing a second time.
            GC.SuppressFinalize(Me)
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "Dispose1() - EXIT")
        End Sub
        ...
        Private Overloads Sub Dispose(ByVal disposing As Boolean)
            ...
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "Dispose() - ENTER")
            ...
            End If
            _Disposed = True
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "Dispose() - EXIT")
        End Sub
        ...
        Protected Overrides Sub Finalize()
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "Finalize() - ENTER")
            Dispose(False)
            MyBase.Finalize()
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "Finalize() - EXIT")
        End Sub
...
#Region "Public methods"
        ...
        Public Function StartProcess() As Boolean
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "StartProcess() - ENTER")
            ...
            Return result
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "StartProcess() - EXIT")
        End Function
        ...
        Public Sub Shutdown()
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "Shutdown() - ENTER")
            _ShuttingDown = True
            If _Proc IsNot Nothing Then
                SyncLock _Proc
                    Try
                ...
                End SyncLock
            End If
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "Shutdown() - EXIT")
        End Sub
...
#Region "Callbacks"
        ...
        Public Sub ProcessExited(ByVal sender As Object, ByVal e As System.EventArgs) Handles _Proc.Exited
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "ProcessExited() - ENTER")
            Dim p As System.Diagnostics.Process
            Dim succeeded As Boolean
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "ProcessExited() - 1")
            If Not _ShuttingDown Then
                If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "ProcessExited() - 2")
                p = CType(sender, System.Diagnostics.Process)
                If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "ProcessExited() - 3")
                succeeded = (p.ExitCode = 0)
                If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "ProcessExited() - 4")
                RaiseEvent evProcessExited(ClientProcessID, Name, p.Id, succeeded)
                If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "ProcessExited() - 5")
            End If
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "ProcessExited() - EXIT")
        End Sub
        ...
        Public Sub ProcessOutput(ByVal sender As Object, ByVal outLine As DataReceivedEventArgs) Handles _Proc.OutputDataReceived ', _Proc.ErrorDataReceived
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "ProcessOutput() - ENTER")
            ...
            If Not _ShuttingDown Then
                ...
                End If
            End If
            If My.Settings.TRACE_LEVEL > 2 Then RaiseEvent evLogLineOutput(ClientProcessID, Name, PID, "ProcessOutput() - EXIT")
        End Sub
